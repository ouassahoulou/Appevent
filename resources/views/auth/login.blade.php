                   ...
                   <br><br><br><br><h3>Admin Area</h3>
                    ...
                    <form  method="POST" action="{{ route('login') }}">
                       ...
                       <div> <label for="login"> {{__('Login')}} </label>   
                         <input class="form-control" type="login" name="login" id="login" placeholder="Set your address"> 
                       </div>
                       <div>
                        <label for="password"> {{__('Password')}} </label>
                        <input class="form-control" type="password" name="password" id="password" placeholder="Set your password">    
                       </div>
